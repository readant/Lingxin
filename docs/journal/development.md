...
| 关键点检测 | MediaPipe | >=0.10.33 | 手部和姿态检测 |
...
### 4.10 视频批量采集工具（2026年6月）

**里程碑**：支持从视频文件批量提取手语关键点
...
**新增内容**：
- `web/index.html` — 首页（学习导航）
- `web/demo.html` — 实时手语识别演示
- `web/docs.html` — 文档在线查看器
- `web/resources.html` — 学习资源导航
- `web/dashboard.html` — 全流程控制台
